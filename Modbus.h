...
#endif
#ifdef CONTROLLINO_MAXI  //normal operation for controllino (these ports are not in use with Arduino Mega)
...
#endif
#ifdef CONTROLLINO_MEGA  //normal operation for controllino (these ports are not in use with Arduino Mega)
   #define RS485_PIN_DE      0b01000000 //PJ6 = 69
   #define RS485_PIN_RE      0b00100000 //PJ5 = 68
   #define RS485_DIR_REG     DDRJ
   #define RS485_PORT_REG    PORTJ
